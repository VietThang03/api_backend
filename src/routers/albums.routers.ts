...
albumRouters.get('/user/:user_id', accessToken_validator, verifiedUserValidator, userIdValidator,paginationValidator, wrapRequestHandler(getAlbumsUserController))
